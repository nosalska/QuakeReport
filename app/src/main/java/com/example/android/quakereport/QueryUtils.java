...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        Log.i(LOG_TAG, "fetchEarthquakeData kicked off");
    ...
    private static ArrayList<Earthquake> extractEarthquakes(String earthquakeJSON) {
        ...
        try {
            ...
            JSONArray earthquakeFeaturesArray = earthquakeData.optJSONArray("features");

            for (int i=0; i < earthquakeFeaturesArray.length(); i++){
               JSONObject currentFeature = earthquakeFeaturesArray.getJSONObject(i);
